...
function Footer() {
    return (
        <div>
            <section className="text-white-600 body-font bg-black">
                <div className="container flex flex-wrap px-5 py-24 mx-auto items-center">
                    <div className="md:w-1/2 md:pr-12 md:py-8  md:border-b-0 mb-10 md:mb-0 pb-10 flex flex-col gap-[30px]  border-white-200 text-start">
                        <div>

                            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Bamboo Training Program</h1>
                            <div className='w-[60%]'>

                                <p className="leading-relaxed text-white">Lorem ipsum dolor sit amet consectetur. Sit enim vestibulum mauris cursus sit. Et at fermentum nec faucibus tempor morbi ipsum.</p>
                            </div>
                    ...
                    <div className='md:w-1/2  flex '>
                        ...
                        <div className="flex flex-col md:w-1/2 md:pl-12">
                            <h2 className="title-font font-semibold text-white-800 tracking-wider text-sm mb-3">Resources</h2>
                            <nav className="flex flex-nowrap list-none flex-col -mb-1 items-center gap-[30px] ">
                                <li className="text-start ">
                                    <a className="text-white hover:text-white">Newsletter</a>
                                </li>
                                <li className="">
                                    <a className="text-white hover:text-white">Notes</a>
                                </li>
                                <li className="">
                                    <a className="text-white hover:text-white">Question Paper</a>
                                </li>
                                <li className="">
                                    <a className="text-white hover:text-white">Syllabus</a>
                                </li>

                            </nav>
                        </div>
                        <div className="flex flex-col md:w-1/2 md:pl-12">
                            <h2 className="title-font font-semibold text-white-800 tracking-wider text-sm mb-3">Policy</h2>
                            <nav className="flex flex-nowrap list-none flex-col -mb-1 items-center gap-[30px]">
                                <li className="lg:w-1/3 mb-1 w-1/2">
                                    <a className="text-white hover:text-white">Refund policy</a>
                                </li>
                                <li className="lg:w-1/3 mb-1 w-1/2">
                                    <a className="text-white hover:text-white">Privacy  Policy </a>
                                </li>
                                <li className="lg:w-1/3 mb-1 w-1/2">
                                    <a className="text-white hover:text-white">Terms of use</a>
                                </li>
